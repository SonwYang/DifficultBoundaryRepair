...
if __name__ == '__main__':
    ...
    parse.add_argument("--targetSize", type=int, default=64, help='the size of target')
    ...
    rootList = ['./tempData/train_images', './tempData/train_gaussian', './tempData/train_labels', './tempData/train_lines']
    outRoot = 'data'
    ...
    for root in rootList:
        if root in ['./tempData/train_lines']:
            subRoot = os.path.join(outRoot, 'train_edges')
        else:
            subRoot = os.path.join(outRoot, root.split('/')[-1])
