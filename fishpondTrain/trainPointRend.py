...
from models.net import FishUnet, FishUnetBase
from models.pointrend import PointRend, PointHead
from modelPR.deeplab import deeplabv3
from models.sampling_points import *
...
class Trainer(object):
    def __init__(self, cfg):
        ...
        self.model = PointRend(FishUnetBase(num_classes=3, in_channels=3), PointHead(num_classes=21)).to(self.device)
    ...
    def validation(self, epoch, dataloader):
        ...
        for batch_id, sample_batched in enumerate(dataloader):
            ...
            loss_seg = self.criterion_seg(segments["fine"], labels_seg)
            ...
            self.save_image_bacth_to_disk(segments["fine"], file_name)
    ...
    def train(self):
        ...
        for epoch in range(1, self.cfg.num_epochs):
            ...
            for batch_id, sample_batched in enumerate(train_loader):
                ...
                loss_seg = self.criterion_seg(segments["coarse"], labels_seg)
                ...
                points_loss = F.cross_entropy(segments["rend"], gt_points, ignore_index=255)
                loss = loss_seg + points_loss
