...
if __name__ == '__main__':
    ...
    cfg = Config()
    root = r'D:\MyWorkSpace\paper\fishpond\data\tempData8\train_images'
    ...
    for i, data_batch in enumerate(train_loader):
        ...
        gaussian = data_batch['gaussian']
        print(img.size(), gaussian.size(), f"max gt : {torch.max(dt)}")
