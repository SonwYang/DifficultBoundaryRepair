...
class Trainer(object):
    def __init__(self, cfg):
        ...
        self.model = smp.Unet(in_channels=cfg.in_chs,
                                      classes=cfg.num_classes,
                                      encoder_weights=None).to(self.device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataRoot', type=str, default=r'Z:\20220312\water', help='path to the root of data')
